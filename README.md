...
## Contenidos
- Diagramas RTL: Se encuentran en «[rtl_schematics](./rtl_schematics)», generados por Vivado como gráficos vectoriales en PDF. Los diagramas se organizan de acuerdo a la jerarquía de los archivos VHDL originales.
- Código VHDL: [to do]
- Archivo de Constraints: [to do]
- Script Python: [to do]
- Diagramas de Diseño: [to do]
