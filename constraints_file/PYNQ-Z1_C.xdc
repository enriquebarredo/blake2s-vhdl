...
#set_property -dict {PACKAGE_PIN G17 IOSTANDARD LVCMOS33} [get_ports status_reading_port]
...
#set_property -dict {PACKAGE_PIN R14 IOSTANDARD LVCMOS33} [get_ports status_ready_to_compress]
#set_property -dict {PACKAGE_PIN P14 IOSTANDARD LVCMOS33} [get_ports status_awaiting_first_block]; #IO_L6P_T0_34 Sch=led[1]
#set_property -dict {PACKAGE_PIN N16 IOSTANDARD LVCMOS33} [get_ports status_awaiting_next_block]
#set_property -dict {PACKAGE_PIN M14 IOSTANDARD LVCMOS33} [get_ports status_digest_is_ready]

##Buttons

set_property -dict {PACKAGE_PIN D19 IOSTANDARD LVCMOS33} [get_ports clr]
